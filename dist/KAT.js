 ...
 */
KAT.model.nameRegEx2 = new RegExp("^(" + KAT.model.nameRegExS + ")\\.(" + KAT.model
  .nameRegExS + ")$");
 ...
 */
KAT.model.nameRegEx3 = new RegExp("^(" + KAT.model.nameRegExS + ")\\.(" + KAT.model
  .nameRegExS + ")\\.(" + KAT.model.nameRegExS + ")$");
...
KAT.model.KAnnSpec = function(xml, url, collection) {
  ...
  try {
    ...
    throw new KAT.model.ParsingError(
      "KAT.model.KAnnSpec: Invalid XML (Unable to parse XML). ", this.xml);
  }

  //check the top level element
  if (this.xml.children().length != 1 || !this.xml.children().eq(0).is(
      "annotation")) {
    throw new KAT.model.ParsingError(
      "KAT.model.KAnnSpec: Invalid XML (Expected exactly one top-level <annotation>). ",
      this.xml);
  }
  ...
  if (!this.name || !KAT.model.nameRegEx.test(this.name)) {
    throw new KAT.model.ParsingError(
      "KAT.model.KAnnSpec: Unable to create KAnnSpec ('" + this.name +
      "' is not a valid name). ", this.xml);
  }

  //validate the sub tags
  var annotRoot = this.xml.children().eq(0);

  if (annotRoot.children().length <= 1 || !annotRoot.children().eq(0).is(
      "documentation")) {
    throw new KAT.model.ParsingError(
      "KAT.model.KAnnSpec: Invalid XML for KAnnSpec '" + this.getFullName() +
      "' (Expected exactly one <documentation>). ", annotRoot);
  }
...
KAT.model.Concept = function(xml, KAnnSpec) {
  ...
  try {
    ...
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid XML (Unable to parse XML). ", this.xml);
  }
  ...
  if (typeof this.xml.attr("name") != "string") {
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid Invalid XML (Missing name attribute for <concept>). ",
      this.xml);
  }
  ...
  if (typeof this.xml.attr("rdftype") != "string") {
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid Invalid XML (Missing rdftype attribute for <concept>). ",
      this.xml);
  }
  ...
  if (!KAT.model.nameRegEx.test(this.name)) {
    throw new KAT.model.ParsingError("KAT.model.Concept: Invalid XML ('" +
      this.getFullName() + "' is not a valid name). ", this.xml);
  }

  //Check if this concept already exists
  if (this.KAnnSpec.getConcept(this.name)) {
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid XML (Concept '" + this.getFullName() +
      "' already exists). ", this.xml);
  }
   ...
   */
  this.rdf_type = KAT.rdf.resolveWithNameSpace(this.xml.attr("rdftype"), this
    .KAnnSpec.xml);

  //validation
  if (this.xml.length != 1 || !this.xml.is("concept")) {
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid XML for concept '" + this.getFullName() +
      "' (Expected exactly one <concept> tag). ", this.xml);
  }
  ...
  if (children.length < 2) {
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid XML for concept '" + this.getFullName() +
      "' (Expected at least 2 of <documentation>, <field>, <display> and <rdf:rdf>). ",
      children);
  }
  ...
  if (children.eq(index).is("display")) {
    ...
    //Set the display
    if (display.children().length != 1 || !display.children().eq(0).is(
        "template")) {
      throw new KAT.model.ParsingError(
        "KAT.model.Concept: Invalid XML for concept '" + this.getFullName() +
        "' (Missing <template>). ", display);
    } else {
    ...
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid XML for concept '" + this.getFullName() +
      "' (Missing required <display>). ", children);
  }
  ...
  if (index < children.length) {
    if (children.eq(index).prop("tagName") == "rdf:RDF") {
      ...
      throw new KAT.model.ParsingError(
        "KAT.model.Concept: Invalid XML for concept '" + this.getFullName() +
        "' (Expected <rdf:rdf> in final position. ). ", children);
    }
  }
  ...
  if (index != children.length) {
    throw new KAT.model.ParsingError(
      "KAT.model.Concept: Invalid XML for concept '" + this.getFullName() +
      "' (Expected at least 2 of <documentation>, <fields>, <display> and <rdf:RDF>). ",
      children);
  }
};
...
KAT.model.Concept.prototype.getDefault = function() {
  ...
  $.each(this.fields, function(field) {
    if (field.type == KAT.model.Field.types.text) {
      ...
      //or the first one.
      defaultValues[field.value] = (field.default === "") ? field.validation[
        0] : field.default;
...
KAT.model.Field = function(xml, concept) {
  ...
  try {
    ...
    throw new KAT.model.Field(
      "KAT.model.Field: Invalid XML (Unable to parse XML). ", this.xml);
  }
  ...
  if (typeof this.xml.attr("name") != "string") {
    throw new KAT.model.ParsingError(
      "KAT.model.Field: Invalid XML (Missing name attribute for <field>). ",
      this.xml);
  }
  ...
  if (!KAT.model.nameRegEx.test(this.name)) {
    throw new KAT.model.ParsingError("KAT.model.Field: Invalid XML ('" + this
      .getFullName() + "' is not a valid name). ", this.xml);
  }

  //Check if this field already exists
  if (this.concept.getField(this.name)) {
    throw new KAT.model.ParsingError("KAT.model.Field: Invalid XML (Field '" +
      this.getFullName() + "' already exists). ", this.xml);
  }

  //do we have the type attribute.
  if (typeof this.xml.attr("type") != "string") {
    throw new KAT.model.ParsingError(
      "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
      "' (Missing type attribute for <field>). ", this.xml);
  }
  ...
  if (typeof this.xml.attr("rdfpred") != "string") {
    throw new KAT.model.ParsingError(
      "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
      "' (Missing rdfpred attribute for <field>). ", this.xml);
  }
   ...
   */
  this.rdf_pred = KAT.rdf.resolveWithNameSpace(this.xml.attr("rdfpred"), this
    .concept.KAnnSpec.xml);
  ...
  this.xml.children().each((function(i, e) {
    ...
    if (e.is("value")) {
      ...
      if (typeof e.attr("atleast")) {
        try {
          ...
          throw new KAT.model.ParsingError(
            "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
            "' (atleast property must be a number). ", e);
        }
      }
      ...
      if (typeof e.attr("atmost")) {
        try {
          ...
          throw new KAT.model.ParsingError(
            "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
            "' (atmost property must be a number). ", e);
        }
      }
      ...
      if (hasDefault) {
        throw new KAT.model.ParsingError(
          "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
          "' (Double <default> tag). ", e);
      }

      //no, so we can store it
      hasDefault = true;
      this.default = e.text();
    } else if (e.is("validation") && this.type == KAT.model.Field.types
      .text) {
      //did we have this already?
      if (hasValidation) {
        throw new KAT.model.ParsingError(
          "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
          "' (Double <validation> tag). ", e);
      }
      ...
      try {
        ...
        throw new KAT.model.ParsingError(
          "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
          "' (Unregonised regular expression). ", e);
      }
    } else if (e.is("referencedType") && this.type == KAT.model.Field.types
      .reference) {
    ...
    } else if (e.is("defaultoption") && this.type == KAT.model.Field.types
      .select) {
      this.validation.push(new KAT.model.Option(e, this));
    } else {
      throw new KAT.model.ParsingError(
        "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
        "' (Unexpected tag '" + e.prop("tagName") + "'). ", e);
    }
  }).bind(this));
  ...
  if (this.type == KAT.model.Field.types.select && this.validation.length ===
    0) {
    throw new KAT.model.ParsingError(
      "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
      "' (KAT.model.Field.types.select must have a non-empty list of options. ). ",
      e);
  }
  ...
  for (var i = 0; i < this.concept.fields.length; i++) {
    if (this.concept.fields[i].value == this.value) {
      throw new KAT.model.ParsingError(
        "KAT.model.Field: Invalid XML for field '" + this.getFullName() +
        "' (Value '" + this.value + "' already used by field '" + this.concept
        .fields[i].getFullName() + "'). ", this.xml);
    }
  }
...
KAT.model.Option = function(xml, field) {
  ...
  try {
    ...
    throw new KAT.model.ParsingError(
      "KAT.model.Option: Invalid XML (Unable to parse XML). ", this.xml);
  }
  ...
  if (this.xml.find("value").length != 1) {
    throw new KAT.model.ParsingError(
      "KAT.model.Option: Invalid XML (Expected exactly one <value>. )",
      this.xml);
  }
  ...
  for (var i = 0; i < this.field.validation.length; i++) {
    if (this.field.validation[i].value == this.value) {
      throw new KAT.model.ParsingError(
        "KAT.model.Option: Invalid XML (Value '" + this.value +
        "' already used). ", this.xml);
    }
  }
  ...
  if (this.xml.is("defaultoption")) {
    if (this.field.default !== "") {
      throw new KAT.model.ParsingError(
        "KAT.model.Option: Invalid XML (Default already exists)", this.xml);
    }
  ...
  if (typeof this.xml.attr("rdfobj") === "string") {
    this.rdf_obj = KAT.rdf.resolveWithNameSpace(this.xml.attr("rdfobj"), this
      .field.concept.KAnnSpec.xml);
  }
  ...
  if (this.xml.children().length > 2) {
    throw new KAT.model.ParsingError(
      "KAT.model.Option: Invalid XML (Too many children. )", this.xml);
  }
...
KAT.sidebar.generateAnnotationReferenceField = function(current, env, wrapper,
  annotation, validations, revalidate) {
  ...
  validations.push(function() {
    ...
    var validates = wrapper.find("select").eq(0).find("option").length >
      0;
  ...
  function createReference(addMinusButtonBool) {
    ...
    if (numFields < atmost) {
      ...
      var allowedAnnotations = env.store.filterByConcept.apply(env.store,
        current.validation);
      ...
      if (addMinusButtonBool) {
        ...
        var minusButton = $("<button class='btn btn-default minusButton " +
          ...
          .on("click", function(event) { // called to remove field
            ...
            wrapper.find(".plusButton." + current.name).removeAttr(
              "disabled");
 ...
 * @memberof KAT.sidebar
 */
KAT.sidebar.generateAnnotationSelectField = function(current, wrapper,
  annotation, validations, revalidate) {
 ...
 * @memberof KAT.sidebar
 */
KAT.sidebar.generateAnnotationTextField = function(current, wrapper, annotation,
  ...
  function createTextField(addMinusButtonBool) {
    ...
    if (numFields < atmost) {
      ...
      var info = "<p>" + current.documentation + "</p><p>" +
        "You are expected to match the following Regular Expression: </br>" +
        RegExpression + "</p>";
 ...
 * @memberof KAT.sidebar
 */
KAT.sidebar.generateAnnotationForm = function(env, callback, annotation,
  selection, concept) {
  ...
  var newAnnotation = $("<li>").append("<h4> " + concept.name + " - " + task +
  ...
  // add a new form
  var newForm = $("<form>").addClass("form-inline").appendTo(newAnnotation).on(
    "submit",
    function(e) {
  ...
  var saveButton = $("<button type='submit'>").addClass("btn btn-primary").text(
    ...
    $.each(concept.fields, function(i, field) {
      ...
      if (field.type == KAT.model.Field.types.reference) {
        ...
        valuesJSON[field.value] = infield.find("select").map(function() {
          return env.store.find($(this).val());
        }).get().slice();
      } else if (field.type == KAT.model.Field.types.select) {
        // for option, store the selected option.
        valuesJSON[field.value] = infield.find("select").map(function() {
          return field.validation[$(this).val()];
        }).get().slice();
      } else {
        // for text, simply store the values of the text fields
        valuesJSON[field.value] = infield.find("input[type=text]").map(
          function() {
            return $(this).val();
          }).get().slice();
      }
  ...
  var cancelButton = $("<button type='button'>").addClass("btn btn-danger").text(
  ...
  var inputFieldGroups = jQuery.map(concept.fields, function(current) {
    ...
    if (current.type === KAT.model.Field.types.text) {
      KAT.sidebar.generateAnnotationTextField(current, wrapper,
        annotation, validations, revalidate);
    } else if (current.type === KAT.model.Field.types.select) {
      KAT.sidebar.generateAnnotationSelectField(current, wrapper,
        annotation, validations, revalidate);
    } else if (current.type === KAT.model.Field.types.reference) {
      KAT.sidebar.generateAnnotationReferenceField(current, env, wrapper,
        annotation, validations, revalidate);
    }
...
(function() {
  ...
  function resolveDefs(c, block, def) {
    return ((typeof block === "string") ? block : block.toString())
      .replace(c.define || skip, function(m, code, assign, value) {
        ...
        if (!(code in def)) {
          if (assign === ":") {
            if (c.defineParams) value.replace(c.defineParams, function(m,
              param, v) {
              def[code] = {
                arg: param,
                text: v
      ...
      .replace(c.use || skip, function(m, code) {
        if (c.useParams) code = code.replace(c.useParams, function(m, s, d,
          param) {
  ...
  doT.template = function(tmpl, c, def) {
    ...
    str = ("var out='" + (c.strip ? str.replace(
            /(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ")
          .replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : str)
        .replace(/'|\\/g, "\\$&")
        ...
        .replace(c.conditional || skip, function(m, elsecase, code) {
          return elsecase ?
            (code ? "';}else if(" + unescape(code) + "){out+='" :
              "';}else{out+='") :
        ...
        .replace(c.iterate || skip, function(m, iterate, vname, iname) {
          ...
          return "';var arr" + sid + "=" + iterate + ";if(arr" + sid +
            "){var " + vname + "," + indv + "=-1,l" + sid + "=arr" + sid +
            ".length-1;while(" + indv + "<l" + sid + "){" + vname +
            "=arr" + sid + "[" + indv + "+=1];out+='";
        })
    ...
    if (needhtmlencode) {
      if (!c.selfcontained && _globals && !_globals._encodeHTML) _globals._encodeHTML =
        doT.encodeHTMLSource(c.doNotSkipEncoded);
      str =
    ...
    try {
      ...
      if (typeof console !== "undefined") console.log(
        "Could not create a template function: " + str);
      throw e;
    }
  };
